...
function registerIpc(): void {
  ...
  ipcMain.handle("desktop:set-sounds-enabled", (_event, value: unknown): void => {
    if (typeof value !== "boolean") throw new Error("Sounds must be enabled or disabled");
    soundsEnabled = value;
    saveSettings({ soundsEnabled });
  });
