...
<table>
  <tr>
    <td width="58%" valign="middle">
      <img src="screenshots/sandbox.png" alt="Snaffle restricted execution and sandbox controls" width="100%">
    </td>
...
<table>
  <tr>
    ...
    <td width="66%" valign="middle">
      <img src="screenshots/customize.png" alt="Snaffle shown across several customizable themes" width="100%">
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="58%" valign="middle">
      <img src="screenshots/allowance.png" alt="OpenCode Go usage allowance shown in Snaffle" width="100%">
    </td>
    <td width="42%" valign="middle">
