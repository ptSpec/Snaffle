...
import { PRODUCT } from "../dist/src/identity.js";
...
const LEGACY_PROMPT = `You are operating inside ${PRODUCT.name}, a coding harness, and work only inside the provided workspace.
